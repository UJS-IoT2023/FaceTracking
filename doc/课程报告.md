...
for (size_t i = 0; i < tracks.size(); ++i) {
    ...
    for (size_t j = 0; j < detections.size(); ++j) {
        ...
        double iou = get_iou(tracks[i].bbox, detectionsbbox);
...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 33%; border: none; text-align: center;">
      <img src="assets/confusion_matrix.png" alt="Dataset Labels" style="width: 100%; height: auto;">
      <p>Dataset Labels</p>
    </td>
    <td style="width: 33%; border: none; text-align: center;">
      <img src="assets/BoxP_curve.png" alt="Precision-Recall Curve" style="width: 100%; height: auto;">
      <p>P-R Curve (BoxP)</p>
    </td>
    <td style="width: 33%; border: none; text-align: center;">
      <img src="assets/BoxR_curve.png" alt="Recall Curve" style="width: 100%; height: auto;">
      <p>Recall Curve (BoxR)</p>
    </td>
  </tr>
</table>
...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 50%; border: none; text-align: center;">
      <img src="assets/labels.jpg" alt="Dataset Labels" style="width: 100%; height: auto;">
      <p>Dataset Labels</p>
    </td>
    <td style="width: 50%; border: none; text-align: center;">
      <img src="assets/val_batch1_pred.jpg" alt="Recall Curve" style="width: 100%; height: auto;">
      <p>val_batch1_pred</p>
    </td>
  </tr>
</table>
